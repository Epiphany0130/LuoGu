...
30 支装，价格为 27。
P 老师需要购买至少 57 支铅笔。
如果她选择购买第一种包装，那么她需要购买29 份，共计 2×29=58 支，需要花费的钱为 2×29=58。
...
*/
 ...
 int main() {
    ...
    int m1_total, m2_total, m3_total;
    cin >> n;
    cin >> n1 >> m1 >> n2 >> m2 >> n3 >> m3;
    m1_total = (ceil)(n / n1) * m1;
    m2_total = (ceil)(n / n2) * m2;
    m3_total = (ceil)(n / n3) * m3;
    if(m1_total < m2_total && m1_total < m3_total)
        cout << m1_total << endl;
    if(m2_total < m1_total && m2_total < m3_total)
        cout << m2_total << endl;
    if(m3_total < m1_total && m3_total < m2_total)
        cout << m3_total << endl;
    return 0;
 }